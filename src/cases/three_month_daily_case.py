...
ax.bar(xs[-90::], ys[-90::],color = "#f46669",linewidth=0.3)
ax.set_title('Daily Covid-19 vaccination cases')
plt.gcf().autofmt_xdate()

three_month_case_canvas = FigureCanvas(fig)  # a Gtk.DrawingArea
three_month_case_canvas.set_size_request(600, 400)
