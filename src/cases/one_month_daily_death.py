...
for case in reversed(death_by_day):
...
ax.bar(xs[-30::], ys[-30::],color = "#6d6d6d",linewidth=0.3)
ax.set_title('Daily Covid-19 vaccination death')
plt.gcf().autofmt_xdate()

one_month_death_canvas = FigureCanvas(fig)  # a Gtk.DrawingArea
one_month_death_canvas.set_size_request(600, 400)
